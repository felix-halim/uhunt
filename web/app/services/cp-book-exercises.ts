...
@Injectable()
export class CpBookExercisesService {

  edition: number;

  private static cp_numbers: number[][] = [];
  private static starred_numbers: any[] = [];
  ...
  set_edition(edition) {
    this._databaseService.set('cpbook_edition', this.edition = edition);
  }

  is_starred(num) {
    if (!CpBookExercisesService.starred_numbers[this.edition]) {
      var arr = {};
      for (let i of CpBookExercisesService.get_cp_numbers(this.edition)) {
        if (i < 0) {
          arr[-i] = true;
        }
      }
      CpBookExercisesService.starred_numbers[this.edition] = arr;
    }
    return CpBookExercisesService.starred_numbers[this.edition][num];
  }

  static get_cp_numbers(ed) {
    if (!CpBookExercisesService.cp_numbers[ed]) {
      var arr = [];
      for (let c of CpBookExercisesService._cpbooks[ed].chapters) {
        for (let sc of c.arr) {
      ...
      CpBookExercisesService.cp_numbers[ed] = arr;
    }
    return CpBookExercisesService.cp_numbers[ed];
  }
  ...
  static _cpbooks = [
    {
      ...
      color: 'blue',
      image: '/images/cp.jpg',
      link: 'http://www.lulu.com/product/paperback/competitive-programming/12110025',
      chapters: [
        {
          ...
          [{
            title: 'Data Structures With Built-in Libraries', arr: [
              ...
              ], ['STL priority_queue <a target="_blank" href="http://www.comp.nus.edu.sg/~stevenha/visualization/heap.html"><img height="15" border"0" src="' + Config.UHUNT_HOST + '/images/img.png"></a>', -908, -11492
              ]]
          }, {
...

    {
      nth: '2nd',
      color: 'brown',
      image: '/images/cp2-small.png',
      link: 'http://www.lulu.com/product/paperback/competitive-programming-2/16377304',
      chapters: [
        {
          title: "Introduction", arr:
          [{
          ...
          [{
            title: "Linear Data Structures with Built-in Libraries", arr: [
              ...
              title: "Non Linear Data Structures with Built-in Libraries", arr: [
                ["C++ STL priority_queue (Java PriorityQueue) <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/heap.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", -1203, -10954, -11995
              ...
              title: "Data Structures with Our-Own Libraries", arr: [
                ["Graph Data Structures Problems <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/representation.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", 599, -10720, -10895, 10928, 11414, 11550, -11991
                ], ["Union-Find Disjoint Sets", 459, -793, 10158, 10178, 10227, -10507, 10583, 10608, 10685, -11503, 11690, 11966
                ], ["Tree-related Data Structures <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/bit.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", 297, 1232, -11235, 11297, 11350, -11402, 11525, -11926, 12086
                ]]
            }]
        }, {
          title: "Problem Solving Paradigms", arr:
          ...
          title: "Graph", arr:
          [{
            title: "Graph Traversal <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/dfsbfs.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", arr: [
              ...
              title: "Minimum Spanning Tree <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/mst.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", arr: [
              ...
              title: "Single-Source Shortest Paths (SSSP) <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/sssp.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", arr: [
              ...
              title: "Maximum Flow <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/maxflow.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", arr: [
          ...
          [{
            title: "Basic Geometry", arr: [
              ...
              title: "Polygon <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/convexhull.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", arr: [
          ...
          [{
            title: "Problem Decomposition", arr: [
              ...
              title: "More Advanced Dynamic Programming", arr: [
                ["DP + bitmask <a target='_blank' href='http://www.comp.nus.edu.sg/~stevenha/visualization/bitmask.html'><img height='15' border'0' src='" + Config.UHUNT_HOST + "/images/img.png'></a>", 1099, 1204, 1252, -10296, 10364, 10651, -10817, 10911, 11218, -11391, 11472, 12063,
...

    {
      ...
      link: 'http://www.lulu.com/shop/steven-halim/competitive-programming-3/paperback/product-21031836.html',
      chapters: [
        {
          title: "Introduction", arr:
          [{
